        ...
        http
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.DELETE, POST + REPORT_POST + "/**").hasRole(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.DELETE, POST + REMOVE_REPORTED_POST + "/**").hasRole(Role.ADMIN.name())
                                .requestMatchers(HttpMethod.DELETE, POST + REPORT_POST + "/**").hasRole(Role.MODERATOR.name())
                                .requestMatchers(HttpMethod.DELETE, POST + REMOVE_REPORTED_POST + "/**").hasRole(Role.MODERATOR.name())
                                .anyRequest()
                                .authenticated()
                )
                .oauth2Login(oauth2 ->
